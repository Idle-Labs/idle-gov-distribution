WITH idleV4_txs AS (
    ...
    WHERE
        idleV4."evt_tx_hash" IN (SELECT evt_Transfer."evt_tx_hash" FROM idle_v4."IdleWBTC_v4_Yield_evt_Transfer" evt_Transfer)
    AND
        idleV4."contract_address" IN ('\x8C81121B15197fA0eEaEE1DC75533419DcfD3151')
    ORDER BY
...
idleV4_redeems AS (
    ...
    INNER JOIN
        idle_v4."IdleWBTC_v4_Yield_call_redeemIdleToken" redeemIdleToken
...
idleV4_mints AS (
    ...
    INNER JOIN
        ...
        ON idleV4_txs."evt_tx_hash"=idleV4_txs_2."evt_tx_hash" AND idleV4_txs."evt_index"=idleV4_txs_2."evt_index"
    INNER JOIN
        idle_v4."IdleWBTC_v4_Yield_call_mintIdleToken" mintIdleToken
...
--/*
SELECT
    idleV4_balances."evt_block_number",
    idleV4_balances."account",
    idleV4_balances."balance",
    p."price"
FROM idleV4_balances
INNER JOIN idleV4_allTxs ON idleV4_allTxs."evt_block_number"=idleV4_balances."evt_block_number"
INNER JOIN prices."layer1_usd_btc" p ON CAST(p."minute" AS varchar)=CONCAT(LEFT(CAST(idleV4_allTxs."evt_block_time" as varchar),'16'),':00+00')
ORDER BY idleV4_balances."evt_block_number" ASC
--*/
/*
SELECT
    idleV4_tlv."evt_block_number",
    (idleV4_tlv."tlv"*p."price") as tlv
FROM
    idleV4_tlv
INNER JOIN idleV4_allTxs ON idleV4_allTxs."evt_block_number"=idleV4_tlv."evt_block_number"
INNER JOIN prices."layer1_usd_btc" p ON CAST(p."minute" AS varchar)=CONCAT(LEFT(CAST(idleV4_allTxs."evt_block_time" as varchar),'16'),':00+00')
ORDER BY idleV4_tlv."evt_block_number" ASC
*/