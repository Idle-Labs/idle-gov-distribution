WITH idleV4_txs AS (
    ...
    WHERE
        idleV4."evt_tx_hash" IN (SELECT evt_Transfer."evt_tx_hash" FROM idle_v4."IdleSUSD_v4_Yield_evt_Transfer" evt_Transfer)
    AND
        idleV4."contract_address" IN ('\xf52cdcd458bf455aed77751743180ec4a595fd3f')
    ORDER BY
...
idleV4_redeems AS (
    ...
    INNER JOIN
        idle_v4."IdleSUSD_v4_Yield_call_redeemIdleToken" redeemIdleToken
...
idleV4_mints AS (
    ...
    INNER JOIN
        ...
        ON idleV4_txs."evt_tx_hash"=idleV4_txs_2."evt_tx_hash" AND idleV4_txs."evt_index"=idleV4_txs_2."evt_index"
    INNER JOIN
        idle_v4."IdleSUSD_v4_Yield_call_mintIdleToken" mintIdleToken
