WITH idleV4_txs AS (
    ...
    WHERE
        idleV4."evt_tx_hash" IN (SELECT evt_Transfer."evt_tx_hash" FROM idle_v4."IdleDAI_v4_Risk_evt_Transfer" evt_Transfer)
    AND
        idleV4."contract_address" IN ('\xa14ea0e11121e6e951e87c66afe460a00bcd6a16')
    ORDER BY
...
idleV4_redeems AS (
    ...
    INNER JOIN
        idle_v4."IdleDAI_v4_Risk_call_redeemIdleToken" redeemIdleToken
...
idleV4_mints AS (
    ...
    INNER JOIN
        ...
        ON idleV4_txs."evt_tx_hash"=idleV4_txs_2."evt_tx_hash" AND idleV4_txs."evt_index"=idleV4_txs_2."evt_index"
    INNER JOIN
        idle_v4."IdleDAI_v4_Risk_call_mintIdleToken" mintIdleToken
