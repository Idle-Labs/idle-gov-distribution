WITH idleV3_txs AS (
    ...
    WHERE
        idleV3."evt_tx_hash" IN (SELECT evt_Transfer."evt_tx_hash" FROM idle_v3."IdleDAI_maxYield_evt_Transfer" evt_Transfer)
    AND
        idleV3."contract_address" IN ('\x78751b12da02728f467a44eac40f5cbc16bd7934')
    ORDER BY
...
idleV3_redeems AS (
    ...
    INNER JOIN
        idle_v3."IdleDAI_maxYield_call_redeemIdleToken" redeemIdleToken
...
idleV3_mints AS (
    ...
    INNER JOIN
        ...
        ON idleV3_txs."evt_tx_hash"=idleV3_txs_2."evt_tx_hash" AND idleV3_txs."evt_index"=idleV3_txs_2."evt_index"
    INNER JOIN
        idle_v3."IdleDAI_maxYield_call_mintIdleToken" mintIdleToken
